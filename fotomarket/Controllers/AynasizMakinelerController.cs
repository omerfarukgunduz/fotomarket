...
namespace fotomarket.Controllers
{
    ...
    public class AynasizMakinelerController : Controller
    {
        // GET: AynasizMakineler
        ...
        {
            data.Table_AynasizFotografMakineleri.Add(x);
            data.SaveChanges();
            return RedirectToAction("Index");
        }
        public ActionResult UrunSil(int id)
        {
            var urun = data.Table_AynasizFotografMakineleri.Find(id);
            data.Table_AynasizFotografMakineleri.Remove(urun);
            data.SaveChanges();
            return RedirectToAction("Index");
        }
        ...
        public ActionResult UrunGuncelle(Table_AynasizFotografMakineleri x)
        {
            var urun = data.Table_AynasizFotografMakineleri.Find(x.ID);
